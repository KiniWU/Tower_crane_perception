...
if __name__ == "__main__":
    ...
    target_image = "/home/tower_crane_data/site_data/test4/sync_camera_lidar/hikrobot/camera1_49.png"
    # target_image = "assets/tower_crane/camera1_36-1-_png.rf.dd69389d01a93eefa2b2a7e0300ff174.jpg"
    prompts = [
        {
            "prompt_image": "assets/tower_crane/camera1_36-1-_png.rf.dd69389d01a93eefa2b2a7e0300ff174.jpg", # "assets/tower_crane/camera2_400_png.rf.db3bd8894c292752e884dbf3386e18d9.jpg",
            "rects": xyxy_box,
        }
    ]
