...
from utils import read_points, write_points, read_calib, read_label, \
    write_pickle, remove_outside_points, get_points_num_in_bbox_site, \
    points_in_bboxes_site_v2
...
def create_data_info_pkl(data_root, data_type, prefix, label=True, db=False):
    ...
    ids_file = os.path.join(CUR, 'dataset', 'SiteImageSets', f'{data_type}.txt')
    ...
    for id in tqdm(ids):
        ...
        if label:
            ...
            annotation_dict['num_points_in_gt'] = get_points_num_in_bbox_site(
